...
const MobileRestaurantDetailPage = () => {
            ...
            {restaurantDetailData ? (
              <DeatilBox key={param.id}>
                ...
                <SideInfoWrapper id="5">
                  <MobileSpotInfo restaurantDetailData={restaurantDetailData} />
                  <MobileStayInfo restaurantDetailData={restaurantDetailData} />
                </SideInfoWrapper>
...
export default MobileRestaurantDetailPage;
